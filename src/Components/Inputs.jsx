...
export default function Inputs({ setInputValue }) {
    ...
    return (
        <div className="flex justify-center align-center p-4 my-6 w-9/12 bg-gray-800 text-white rounded-2xl">
            ...
            <button type="button" onClick ={ addMessage } className="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-13 py-3  dark:bg-gray-900 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Ask</button>
        </div>
    );
}